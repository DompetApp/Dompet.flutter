...
export 'package:dompet/routes/delegate.dart';
export 'package:dompet/routes/routes.dart';
export 'package:dompet/models/web.dart';
...
class Webview {
  ...
  static Future<dynamic> format(dynamic arguments) async {
    if (arguments is! WebviewMeta) {
      return Future.error(GetNavigateError.webview);
    }
...
enum GetNavigateError { webview, route }
